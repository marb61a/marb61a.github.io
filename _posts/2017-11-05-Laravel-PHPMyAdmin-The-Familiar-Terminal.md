...
**Laravel**
  ...
  **PHPMYADMIN**
  ...
  a few basics
        ...
        sudo apt-get purge phpmyadmin*         - This resets and there is no space between the n and the asterisk
 
 
  This did not have the desired effect so I tried this 
  
        sudo gedit /etc/apache2/apache2.conf    - Needs elevated permissions to edit this file
        Include /etc/phpmyadmin/apache.conf     - Added at file end 
        /etc/init.d/apache2 restart             - To restart your Apache server, have root password handy
  ...
  Once again command line 1 gui based tools 0
