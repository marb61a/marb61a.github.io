...
**Some Links, Tips & Thoughts for the day**
  ...
  past few weeks, so I clicked the update now button and set the process in motion.
    ...
    ![image of boredom] (http://i67.tinypic.com/2ch4e0.jpg)
  ...
  which would be incovenient. There are some good and bad things about the update
    ...
    - By far my biggest annoyance is what the OS tells you can be removed, towards the end of the installation the installer
      ...
      to remove them which is where my frustration comes from as among these files are installation files for PHP7 and others.
      This led to some frustration as I could reinstall PHP and MYSQL etc as well as Phpmyadmin but I had a lot of connection
      problems due to a missing mbstring. Eventually I managed to find the solution
    ...
    - Also on the annoyance list is the opening of an unknown icon which is something to do with an OpenGL rendere
